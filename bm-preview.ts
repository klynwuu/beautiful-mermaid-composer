...
function gallery(themeKey: 'perplexity' | 'perplexity-dark'): string {
  ...
  const cards = SAMPLES.map((s) => {
    const svg = renderMermaidSVG(s.code, { ...colors, font: SANS, transparent: true, edgeStyle: 'curved' })
    return `
      <figure class="card">
...
<body>
  <div class="wrap">
    ...
    <footer>
      Generated by <code>bm-preview.ts</code> · themes live in <code>src/theme.ts</code> (<code>perplexity</code>, <code>perplexity-dark</code>) · references:
